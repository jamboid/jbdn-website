...
Site.carousel = (function ($) {
  ...
  //////////////////
        ...
        Carousel = function (elem) {
          ...
          /**
           * Update the carousel index to a specific value
           * @function
           * @parameter index - int
           */
          setIndexToValue = function(index) {
            $carouselIndex.find('.indexItem').removeClass('current');

            if(mode === 'scroll'){
              $carouselIndex.find('.indexItem').eq(index).addClass('current');
            } else if (mode === 'fade') {
              $carouselIndex.find('.indexItem').eq(index).addClass('current');
            }
          },
...
//             Site.utils.cl("Items to scroll: " + slidesToScroll + ", " + "Number of items: " + $slides.length + ", " + "Distance to scroll: " + moveWidth);
          ...
          bindCustomMessageEvents = function () {
            ...
            $thisCarousel.off('toggleautocycle');
            $thisCarousel.on('toggleautocycle', function (e) {
              e.preventDefault();
              toggleAutoCycle();
            });

            $thisCarousel.off('controlclicked');
